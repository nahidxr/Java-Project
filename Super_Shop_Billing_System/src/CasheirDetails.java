...
public class CasheirDetails extends JFrame {
    private Container c;
    ...
    private String[] colums={"Cashier Id", "Name","Mobile No","Address","Email-Id","Password"};
    ...
    private void initComponent() {
       ...
       // c.setBackground(Color.white);
        ...
        heading.setBounds(0,0,1200,40);


        pName=new JLabel("CASHIER DETAILS");
        pName.setFont(font);
        ...
        b1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(e.getSource()==b1) {
                    ...
                    try {
                        FileWriter fw = new FileWriter("files/cashierinfo.txt", true);
